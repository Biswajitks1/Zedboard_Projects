...
namespace eval ::optrace {
  variable script "E:/Vivado_Projects/oledControl/oledControl.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet E:/Vivado_Projects/oledControl/oledControl.runs/synth_1/top.dcp
